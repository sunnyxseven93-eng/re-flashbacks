...
Hierarchy scuttlebug_geo[] = {
 ...
 hmsScale(0.25f)
    hmsBegin()
      hmsJoint(RM_SURF,NULL,0,0,0)  /* chn8(39) */
      hmsBegin()
         ...
         hmsBegin()
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     ...
                     hmsBegin()
                        hmsJoint(RM_SURF,RCP_walker_walk0,0,0,0)  /* w_footA(0) */
                     hmsEnd()
                     hmsJoint(RM_SURF,RCP_walker_walk1,0,0,0)  /* w_legA2(1) */
                  hmsEnd()
                  hmsJoint(RM_SURF,RCP_walker_walk2,0,0,0)  /* w_legA1(2) */
               hmsEnd()
            hmsEnd()
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     ...
                     hmsBegin()
                        hmsJoint(RM_SURF,RCP_walker_walk3,0,0,0)  /* w_footB(3) */
                     hmsEnd()
                     hmsJoint(RM_SURF,RCP_walker_walk4,0,0,0)  /* w_legB2(4) */
                  hmsEnd()
                  hmsJoint(RM_SURF,RCP_walker_walk5,0,0,0)  /* w_legB1(5) */
               hmsEnd()
            hmsEnd()
            hmsJoint(RM_SURF,RCP_walker_walk15,0,0,0)  /* w_body(35) */
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     hmsJoint(RM_SURF,RCP_walker_walk6,0,0,0)  /* w_eyeL(6) */
                  hmsEnd()
               hmsEnd()
            hmsEnd()
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     hmsJoint(RM_SURF,RCP_walker_walk7,0,0,0)  /* w_eyeR(7) */
                  hmsEnd()
               hmsEnd()
            hmsEnd()
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     ...
                     hmsBegin()
                        hmsJoint(RM_SURF,RCP_walker_walk8,0,0,0)  /* w_footC(8) */
                     hmsEnd()
                     hmsJoint(RM_SURF,RCP_walker_walk9,0,0,0)  /* w_legC2(9) */
                  hmsEnd()
                  hmsJoint(RM_SURF,RCP_walker_walk10,0,0,0)  /* w_legC1(10) */
               hmsEnd()
            hmsEnd()
            ...
            hmsBegin()
               ...
               hmsBegin()
                  ...
                  hmsBegin()
                     ...
                     hmsBegin()
                        hmsJoint(RM_SURF,RCP_walker_walk11,0,0,0)  /* w_footD(11) */
                     hmsEnd()
                     hmsJoint(RM_SURF,RCP_walker_walk12,0,0,0)  /* w_legD2(12) */
                  hmsEnd()
                  hmsJoint(RM_SURF,RCP_walker_walk13,0,0,0)  /* w_legD1(13) */
               hmsEnd()
            hmsEnd()
            hmsJoint(RM_SURF,RCP_walker_walk14,0,0,0)  /* w_eyebrow(14) */
         hmsEnd()
      hmsEnd()
   hmsEnd()
 hmsExit()
